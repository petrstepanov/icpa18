    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h4 class="mt-2 mb-4">Account Information</h4>
                ...
                <div class="form-group row">
                    <label for="input-password" class="col-12 col-lg-3 col-form-label">Password</label>
                    <div class="col-12 col-lg-9">
                        <input class="form-control" type="password" id="input-password">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="input-password-2" class="col-12 col-lg-3 col-form-label">Repeat password</label>
                    <div class="col-12 col-lg-9">
                        <input class="form-control" type="password" id="input-password-2">
                    </div>
                </div>
                <h4 class="mt-5 mb-4">Personal Information</h4>
                <div class="form-group row">
                    <label for="input-email" class="col-12 col-lg-3 col-form-label">Title</label>
                    <div class="col-12 col-lg-9">
                ...
                <div class="form-group row">
                    <label for="input-first-name" class="col-12 col-lg-3 col-form-label">First name</label>
                    <div class="col-12 col-lg-9">
                        <input class="form-control" type="text" id="input-first-name">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="input-middle-name" class="col-12 col-lg-3 col-form-label">Middle name</label>
                    <div class="col-12 col-lg-9">
                        <input class="form-control" type="text" id="input-middle-name" placeholder="Optional">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="input-last-name" class="col-12 col-lg-3 col-form-label">Last name</label>
                    <div class="col-12 col-lg-9">
                        <input class="form-control" type="text" id="input-last-name">
                    </div>
                </div>
                <h4 class="mt-5 mb-4">Contribution Details</h4>
                <div class="form-group row">
                    <label for="input-email" class="col-12 col-lg-3 col-form-label">Participant type</label>
                    <div class="col-12 col-lg-9">
                        <div class="btn-group btn-group-input" data-toggle="buttons">
                            <label class="btn btn-primary active">
                ...
                <div class="form-group row">
                    <label for="input-organization" class="col-12 col-lg-3 col-form-label">Organization</label>
                    <div class="col-12 col-lg-9">
                        <input class="form-control" type="text" id="input-organization">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="input-country" class="col-12 col-lg-3 col-form-label">Country</label>
                    <div class="col-12 col-lg-9">
                ...
                <div class="form-group row">
                    <label for="input-email" class="col-12 col-lg-3 col-form-label">Contribution</label>
                    <div class="col-12 col-lg-9">
                        <div class="btn-group btn-group-input" data-toggle="buttons">
                            <label class="btn btn-primary active">
                ...
                <div class="form-group row">
                    <label for="input-title" class="col-12 col-lg-3 col-form-label">Title</label>
                    <div class="col-12 col-lg-9">
                        <input class="form-control" type="text" id="input-title">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="input-comments" class="col-12 col-lg-3 col-form-label">Comments</label>
                    <div class="col-12 col-lg-9">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-warning">Register for ICPA-18</button>
            </div>
        </div>
    </div>
</div>
