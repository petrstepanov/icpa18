...
<div class="container-wrapper container-wrapper-primary-darker pt-4 pb-3">
	<div class="container">
...
<div class="container pb-4">
	<div class="row">
		<div class="col-lg-9">
			<form>
				<h4 class="mt-5 mb-4">Account Information</h4>
                ...
                <div class="form-group row">
                    <label for="input-password" class="col-md-3 col-form-label">Password</label>
                    <div class="col-md-9">
                        <input class="form-control" type="password" id="input-password">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="input-password-2" class="col-md-3 col-form-label">Repeat password</label>
                    <div class="col-md-9">
                ...
                <div class="form-group row">
                    <label for="input-first-name" class="col-md-3 col-form-label">First name</label>
                    <div class="col-md-9">
                        <input class="form-control" type="text" id="input-first-name">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="input-middle-name" class="col-md-3 col-form-label">Middle name</label>
                    <div class="col-md-9">
                        <input class="form-control" type="text" id="input-middle-name" placeholder="Optional">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="input-last-name" class="col-md-3 col-form-label">Last name</label>
                    <div class="col-md-9">
                ...
                <div class="form-group row">
                    <label for="input-organization" class="col-md-3 col-form-label">Organization</label>
                    <div class="col-md-9">
